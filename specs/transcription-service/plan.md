...
### [x] T1: Package scaffold, tooling and NOTICE  [deps: —]
...
### [x] T2: Error taxonomy and provider-fault classifier  [deps: T1]
...
### [x] T3: Silence and hallucination filters  [deps: T1]
...
### [x] T4: Layered configuration  [deps: T1]
...
### [x] T5: SQLite job ledger  [deps: T1]
...
### [x] T6: Path allowlist and traversal defence  [deps: T2]
...
### [x] T7: Transcript schema and atomic writer  [deps: T2]
...
### [x] T8: Provider protocol, registry and test fakes  [deps: T2]
...
### [x] T9: Structured logging and the ready-line emitter  [deps: T1]
...
### [x] T10: Local faster-whisper provider  [deps: T3, T4, T8]
...
### [x] T11: litellm cloud provider  [deps: T4, T8]
...
### [x] T12: Serial job manager (queue, progress, cancel, ledger, transcript)  [deps: T5, T6, T7, T8]
...
### [x] T14: Server entrypoint, loopback binding and the ready line  [deps: T13]
...
### [x] T15: CLI — `serve` and one-shot `transcribe`  [deps: T14]
...
### [x] T16: Attribution audit, provider-isolation guard, opt-in GPU test, docs  [deps: T15]
