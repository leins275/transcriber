...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::embedding_model_download_status,
            commands::start_embedding_model_download,
            commands::cancel_embedding_model_download,
            ...
            commands::speakers::cancel_diarization_runtime_download,
            commands::speakers::diarization_model_download_status,
            commands::speakers::start_diarization_model_download,
