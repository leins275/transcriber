...
every direct (non-`make`) command — lives in `docs/setup.md`.
...
`%APPDATA%\com.transcriber.desktop\config.json`. See `docs/config-contract.md`
...
- `docs/setup.md` — host prerequisites, dev inner loop, and the build/install
  procedure in full.
- `docs/config-contract.md` — the settings file schema and sidecar handshake.
- `docs/manual-smoke-checklist.md` — the app-behavior checklist (F1's
